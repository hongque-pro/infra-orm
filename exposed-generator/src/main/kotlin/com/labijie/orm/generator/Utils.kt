...
fun TypeSpec.Builder.addComments(classComment: String, context: GenerationContext): TypeSpec.Builder {
    ...
    val comment = CodeBlock.builder()
        ...
        .add("Generator Version: ${context.options.ormVersion}\n")
        .add("\n")
        .add("\n")
...
fun buildWriterOptions(toolVersion: String, env: Map<String, String>): WriterOptions {
