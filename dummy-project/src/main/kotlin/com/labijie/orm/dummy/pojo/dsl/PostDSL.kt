...
public object PostDSL {
  ...
  private fun <T> Post.getColumnValueString(column: Column<T>): String = when(column) {
    ...
    else->throw IllegalArgumentException("""Can't converter value of Post::${column.name} to string.""")
  }
  ...
  public fun UpdateBuilder<*>.setValue(raw: Post, vararg ignore: Column<*>): Unit = assign(this, raw, ignore = ignore)

  public fun UpdateBuilder<*>.setValueSelective(raw: Post, vararg selective: Column<*>): Unit = assign(this, raw, selective = selective)
  ...
  public fun PostTable.updateByPrimaryKey(raw: Post, vararg selective: Column<*>): Int = update(raw, selective = selective, ignore = arrayOf(id)) {
    PostTable.id.eq(raw.id)
  }

  public fun PostTable.updateByPrimaryKey(id: Long, builder: PostTable.(UpdateStatement) -> Unit): Int = update({ PostTable.id.eq(id) }, body = builder)
  ...
  public fun PostTable.selectByPrimaryKeys(ids: Iterable<Long>, vararg selective: Column<*>): List<Post> {
    val query = selectSlice(*selective).andWhere {
  ...
  public fun PostTable.selectMany(vararg selective: Column<*>, `where`: Query.() -> Query?): List<Post> {
