...
public object UserDSL {
  ...
  public fun assign(
    ...
    if((selective == null || selective.contains(status)) && !ignore.contains(status))
      builder[status] = raw.status
    if((selective == null || selective.contains(count)) && !ignore.contains(count))
      builder[count] = raw.count
    if((selective == null || selective.contains(description)) && !ignore.contains(description))
