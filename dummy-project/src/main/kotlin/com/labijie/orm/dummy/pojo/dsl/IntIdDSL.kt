...
public object IntIdDSL {
  ...
  private fun <T> IntId.getColumnValueString(column: Column<T>): String = when(column) {
    ...
    IntIdTable.id->this.id.toString()
        ...
        IllegalArgumentException("""Can ot converter value of IntId::${column.name} to string.""")
  }
  ...
  private fun <T> parseColumnValue(valueString: String, column: Column<T>): T {
    val value = when(column) {
      ...
      IntIdTable.byteCol ->com.labijie.infra.orm.ExposedConverter.stringToByteArray(valueString)
