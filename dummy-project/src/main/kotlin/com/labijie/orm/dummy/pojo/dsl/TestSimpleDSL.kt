...
public object TestSimpleDSL {
  ...
  public fun applyInsert(statement: UpdateBuilder<*>, raw: TestSimple): Unit {
  ...
  public fun applyUpdate(statement: UpdateStatement, raw: TestSimple): Unit {
    statement[name] = raw.name
    statement[memo] = raw.memo
    statement[charCol] = raw.charCol
    statement[textCol] = raw.textCol
  ...
  public fun ResultRow.toTestSimple(): TestSimple = parseRow(this)

  public fun Iterable<ResultRow>.toTestSimpleList(): List<TestSimple> = this.map(::parseRow)
