...
public object ShopDSL {
  ...
  private fun <T> Shop.getColumnValueString(column: Column<T>): String = when(column) {
    ...
    else->throw IllegalArgumentException("""Can't converter value of Shop::${column.name} to string.""")
  }
  ...
  public fun UpdateBuilder<*>.setValue(raw: Shop, vararg ignore: Column<*>): Unit = assign(this, raw, ignore = ignore)

  public fun UpdateBuilder<*>.setValueSelective(raw: Shop, vararg selective: Column<*>): Unit = assign(this, raw, selective = selective)
  ...
  public fun ShopTable.updateByPrimaryKey(raw: Shop, vararg selective: Column<*>): Int = update(raw, selective = selective, ignore = arrayOf(id)) {
    ShopTable.id.eq(raw.id)
  }

  public fun ShopTable.updateByPrimaryKey(id: Long, builder: ShopTable.(UpdateStatement) -> Unit): Int = update({ ShopTable.id.eq(id) }, body = builder)
  ...
  public fun ShopTable.selectByPrimaryKeys(ids: Iterable<Long>, vararg selective: Column<*>): List<Shop> {
    val query = selectSlice(*selective).andWhere {
  ...
  public fun ShopTable.selectMany(vararg selective: Column<*>, `where`: Query.() -> Query?): List<Shop> {
