...
public object TestEntityDSL {
  public fun parseRow(raw: ResultRow): TestEntity {
  ...
  public fun applyInsert(statement: UpdateBuilder<*>, raw: TestEntity): Unit {
  ...
  public fun applyUpdate(statement: UpdateStatement, raw: TestEntity): Unit {
    statement[name] = raw.name
    statement[memo] = raw.memo
    statement[charCol] = raw.charCol
    statement[textCol] = raw.textCol
  ...
  public fun ResultRow.toTestEntity(): TestEntity = parseRow(this)

  public fun Iterable<ResultRow>.toTestEntityList(): List<TestEntity> = this.map(::parseRow)
